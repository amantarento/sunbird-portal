...
let envVariables = {
  LEARNER_URL: 'https://dev.open-sunbird.org/api/',
  CONTENT_URL: 'https://dev.open-sunbird.org/api/',
  CONTENT_PROXY_URL: 'https://dev.open-sunbird.org',
